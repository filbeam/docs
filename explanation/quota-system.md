...
Start with a balanced split and monitor your actual cache hit ratio via the [Stats API](../reference/stats-api.md) or [FilBeam Dashboard](https://calibration.dashboard.filbeam.com). Adjust future top-ups based on observed patterns.
